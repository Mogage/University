...
public class TicketRepository extends AbstractRepository<Ticket, Integer> implements ITicketRepository {
    ...
    protected PreparedStatement createInsertStatement(Connection connection, Ticket entity) throws SQLException {
        ...
        statement.setInt(4, entity.getSeatNumber());
        statement.setString(5, entity.getTouristName());
        return statement;
    }
    ...
    public void add(Ticket elem) {
        super.sqlCommand = "INSERT INTO tickets (id, flight_id, invoice_id, seat_number, tourist_name) VALUES (?, ?, ?, ?, ?)";
        super.add(elem);
    }
