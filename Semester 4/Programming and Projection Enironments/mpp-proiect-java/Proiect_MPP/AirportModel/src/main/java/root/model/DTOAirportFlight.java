...
public class DTOAirportFlight implements Entity<Integer>, Serializable {
    private int id;
    ...
    public Flight toFlight() {
        return new Flight(this.id, this.freeSeats, 1, 2, this.departureDate, this.departureTime);
    }
}
