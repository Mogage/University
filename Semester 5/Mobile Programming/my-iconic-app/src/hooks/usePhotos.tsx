...
export function usePhotos(calendarItemId: string) {
  ...
  async function takePhoto() {
    ...
    await set(PHOTOS + calendarItemId, JSON.stringify(newPhotos));
    setPhotos(newPhotos);
  }
  ...
  function loadPhotos() {
    ...
    async function loadSavedPhotos() {
      const savedPhotoString = await get(PHOTOS + calendarItemId);
      const savedPhotos = (
