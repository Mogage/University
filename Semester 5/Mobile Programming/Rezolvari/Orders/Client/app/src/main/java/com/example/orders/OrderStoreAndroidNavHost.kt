...
import com.example.orders.auth.LoginScreen
...
fun OrderStoreAndroidNavHost() {
    ...
    val myAppViewModel = viewModel<OrderStoreViewModel>(factory = OrderStoreViewModel.Factory)
    NavHost(
        ...
        composable(ordersRoute) {
            OrdersScreen(
                onOrderClick = { orderId ->
                    Log.d("MyAppNavHost", "navigate to order $orderId")
                    navController.navigate("$ordersRoute/$orderId")
                },
                onAddOrder = {
                    Log.d("MyAppNavHost", "navigate to new order")
                    navController.navigate("$ordersRoute-new")
                },
                onLogout = {
